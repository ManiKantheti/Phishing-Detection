...
def extract_url_features(url):
    ...
    suspicious_tld = True if parsed_url.netloc.endswith('.xyz') else False
    ...
    try:
        ...
        domain_in_title = True if title and domain in title else False
    except:
...
if predict_button:
    try:
        ...
        with open('models/rf_model_new.pkl', 'rb') as model_file:
